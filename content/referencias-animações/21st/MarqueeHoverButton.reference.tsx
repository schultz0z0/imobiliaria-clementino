/**
 * Fonte: 21st.dev — Marquee Hover Button, ID 8407
 * Autor: moazamtrade
 * URL: https://21st.dev/@moazamtrade/components/marquee-hover-button
 * Código fornecido pelo usuário em 2026-08-14.
 *
 * Preservado como referência. Confirmar licença antes de uso comercial.
 * Atenção: a saída recebida referencia `btn23-marquee`, mas não inclui o CSS
 * global/keyframes dessa classe. O TSX compila; o efeito visual exige esse CSS.
 */
