...
export const Services = () => {
  ...
  return (
    <div className="relative z-10 pb-24 pt-36 md:pt-44"><div className="container mx-auto px-6"><Breadcrumbs items={[{ label: 'Início', path: '/' }, { label: 'Serviços' }]} /><div className="max-w-4xl"><p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#d7b661]">Serviços imobiliários</p><h1 className="mt-5 text-[2.5rem] font-semibold leading-[1.08] tracking-tight text-white sm:text-5xl md:text-7xl">Suporte claro para cada etapa do imóvel.</h1><p className="mt-7 max-w-2xl text-lg leading-relaxed text-white/55">Da busca à documentação, a Clementino organiza o atendimento de acordo com a necessidade de cada cliente.</p></div>
