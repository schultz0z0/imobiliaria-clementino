  ...
  <section className="property-filters" aria-labelledby="property-filters-title">
    ...
    >
      ...
      <div className="filter-grid">
        <label><span>Status</span><select name="status" defaultValue={initialValues.status ?? ''}><option value="">Todos</option><option value="published">Publicados</option><option value="rented">Alugados</option><option value="draft">Rascunhos</option><option value="inactive">Inativos</option></select></label>
